...
cfg.DATASET.RUN_DFS.FILENAMES = [f for f in subset_filenames if 'nclasses_2' in f]
print("-----------------------") 
...
cfg.DATASET.ARTIFICIAL_SETS_TO_RUN = [(dark_path,bright_path,NAT_DATA_PATH)]
...
cfg.OUTPUT = CN()
cfg.OUTPUT.SAVE_PATH = os.path.join(base_path,'experiments/Experiment_6_Multiple/Experiment_6_2classes_DX')
