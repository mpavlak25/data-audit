...
cfg.DATASET.ARTIFICIAL_SETS_TO_RUN = [(dark_path,bright_path)]
...
cfg.OUTPUT = CN()
cfg.OUTPUT.SAVE_PATH = os.path.join(base_path,'experiments/Experiment_6_Multiple/Experiment_6_2classes')
