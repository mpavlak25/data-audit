...
cfg.DATASET.ARTIFICIAL_SETS_TO_RUN = [(dark_path,bright_path,red_path,green_path,blue_path,yellow_path,purple_path,cyan_path,NAT_DATA_PATH)]
...
cfg.OUTPUT = CN()
cfg.OUTPUT.SAVE_PATH = os.path.join(base_path,'experiments/Experiment_6_Multiple/Experiment_6_8classes_DX')
