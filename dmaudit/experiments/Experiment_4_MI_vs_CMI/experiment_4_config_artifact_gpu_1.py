...
cfg.EXPERIMENT = CN()
cfg.EXPERIMENT.NAME = "Experiment_4_Artifact"
...
cfg.DATASET.RUN_DFS.FOLDER_PATH = os.path.join(base_path, 'experiments/Experiment_4_MI_vs_CMI/Experiment_4_Train_DFs')


subset_filenames = glob.glob(os.path.join(cfg.DATASET.RUN_DFS.FOLDER_PATH,'*'))
subset_filenames_find = ['fixedn_1000_ham10k_oddsratio_-1.00.csv',
                         'fixedn_1000_ham10k_oddsratio_0.19.csv',
                         'fixedn_1000_ham10k_oddsratio_0.67.csv',
                         'fixedn_1000_ham10k_oddsratio_1.00.csv']
...
cfg.DATASET.ARTIFICIAL_SETS_TO_RUN = [
                                      (NAT_DATA_PATH, compression_50_path),
                                      (NAT_DATA_PATH, compression_70_path),
                                      (NAT_DATA_PATH, compression_90_path),
                                      (NAT_DATA_PATH, compression_95_path),
...
cfg.OUTPUT = CN()
cfg.OUTPUT.SAVE_PATH = os.path.join(base_path,'experiments/Experiment_4_MI_vs_CMI/Experiment_4_Artifact_Results')
