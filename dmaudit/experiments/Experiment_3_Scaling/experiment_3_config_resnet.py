...
# -------------------  Mitchell Run ---------------------------
cfg.MODEL.ARCH_NAMES = ['resnet18'] #convnext_tiny next
cfg.MODEL.PRETRAINED = True
cfg.OUTPUT = CN()
cfg.OUTPUT.SAVE_PATH = os.path.join(base_path,'experiments/Experiment_3_Scaling/Experiment_3_Results_ResNet')
