...
subset_filenames_find = [curr_attribute+'_ham10k.csv']
...
cfg.DATASET.ARTIFICIAL_SETS_TO_RUN = [[NAT_DATA_PATH]*HAM_NUM_CATEGORIES[curr_attribute]]

cfg.MODEL = CN()
# This is primarily attribute prediction, so we assume a strong model would do even better
cfg.MODEL.NUM_LAST_LAYER_OUTPUTS = HAM_NUM_CATEGORIES[curr_attribute]
cfg.MODEL.ARCH_NAMES = ['resnet18']
cfg.MODEL.PRETRAINED = True
cfg.OUTPUT = CN()
cfg.OUTPUT.SAVE_PATH = os.path.join(base_path,'experiments/Experiment_5_Natural/Experiment_5_'+curr_attribute)
