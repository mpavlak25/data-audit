...
subset_filenames_find = ['sex_ham10k.csv',
                         'scale_ham10k.csv',
                         'marked_ham10k.csv',
                         ]
...
cfg.OUTPUT = CN()
cfg.OUTPUT.SAVE_PATH = os.path.join(base_path,'experiments/Experiment_5_Natural/Experiment_5_Binary_Attribute_Results')
